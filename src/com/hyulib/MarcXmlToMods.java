...
/**
 * Created by sklee on 2016. 2. 20..
 */
public class MarcXmlToMods {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (tFactory.getFeature(SAXSource.FEATURE)
            ...
            OutputStream out = new FileOutputStream("summerland.html");
            ...
            InputStream input = new FileInputStream("resources/summerland.mrc");
